...
erDiagram
direction TB
FACT_ORDERS ||--o| DIM_RECIPE_REVIEWS: can have
FACT_ORDERS ||--o{ BRIDGE_RECIPES_QUICK_COMMENTS: can have
BRIDGE_RECIPES_QUICK_COMMENTS }|--|| DIM_QUICK_COMMENTS: has many
